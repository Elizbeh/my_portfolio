...
const ProjectCards = ({ project, index, isDarkMode }) => {
  const cardVariants = {
      ...
      >
        ...
        <div className="relative overflow-hidden">
          ...
          <motion.div
            ...
            className="absolute inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center space-x-4 opacity-0 group-hover:opacity-100"
          >
            <motion.a
              ...
              className="bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-full flex items-center space-x-2 text-sm font-medium transition-colors"
            >
        ...
        {/* Project Content Section BELOW the image */}
        <div className="p-6">
          <h3 className="text-xl font-medium mb-3 group-hover:text-purple-500 transition-colors">
            {project.title}
          </h3>
          <p
