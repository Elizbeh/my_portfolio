  ...
  return <AnimatePresence>
    {showSuccess && (
        ...
        >
            ...
            className={`relative p-8 rounded-2xl border max-w-sm w-full ${
                    isDarkMode
        ...
        >
            <button
                ...
                className={`absolute top-4 right-4 p-1 rounded-full transition-colors ${
                    isDarkMode ? "hover:bg-gray-700" : "hover:gb-gray-100"    
                } `}
            >
                <X size={18}/>
            </button>
        ...
        >
            <Sparkles className="text-yellow-500 m-auto" size={24}/>
        </motion.div>
        </motion.div>
        </motion.div>
    )}
